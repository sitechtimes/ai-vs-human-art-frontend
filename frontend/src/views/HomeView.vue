...
.btn {
  @apply !border-[3px] border-primary-200 dark:border-primary-700 transition duration-300 ease-in-out -rotate-6 hover:scale-125 press-start-2p-regular h-12 text-center rounded-none hover:dark:!bg-primary-700 hover:!bg-primary-500;
}
</style>
